...
# count from 0-255-0-255 forever
code = """
ldi 1 ; load 1 into Register A
sta 15 ; store 1 into ram [15]
OUT ; output A
ADD 15 ; add ram [15] to A
JC 6 ; if over 255, jump to SUB 15
JMP 2 ; otherwise go back to ADD 15
SUB 15 ; subtract [15] from A
OUT ; output A
JZ 2 ; if 0, go back to adding
JMP 6 ; else, keep subtracting
"""
